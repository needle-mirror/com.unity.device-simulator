...
namespace UnityEditor.UIElements
{
    ...
    internal class TwoPaneSplitView : VisualElement
    {
        ...
        public new class UxmlTraits : VisualElement.UxmlTraits
        {
            ...
            UxmlIntAttributeDescription m_MinFirstPaneSize = new UxmlIntAttributeDescription { name = "minimum-first-pane-size", defaultValue = 100 };
            UxmlIntAttributeDescription m_MinSecondPaneSize = new UxmlIntAttributeDescription { name = "minimum-second-pane-size", defaultValue = 100 };
            ...
            public override void Init(VisualElement ve, IUxmlAttributes bag, CreationContext cc)
            {
                ...
                var minFirstPaneSize = m_MinFirstPaneSize.GetValueFromBag(bag, cc);
                var minSecondPaneSize = m_MinSecondPaneSize.GetValueFromBag(bag, cc);
                var orientationStr = m_Orientation.GetValueFromBag(bag, cc);
                var orientation = orientationStr == "horizontal"
                    ? Orientation.Horizontal
                    : Orientation.Vertical;

                ((TwoPaneSplitView)ve).Init(fixedPaneIndex, fixedPaneInitialSize, minFirstPaneSize, minSecondPaneSize, orientation);
            }
        }
        ...
        public TwoPaneSplitView(int fixedPaneIndex, float fixedPaneStartDimension, float minfirstDimension, float minSecondDimension, Orientation orientation)
            : this()
        {
            Init(fixedPaneIndex, fixedPaneStartDimension, minfirstDimension, minSecondDimension, orientation);
        }

        public void Init(int fixedPaneIndex, float fixedPaneInitialDimension, float minfirstDimension, float minSecondDimension, Orientation orientation)
        {
        ...
        void PostDisplaySetup()
        {
            ...
            if (m_FixedPaneIndex == 0)
                m_Resizer = new SquareResizer(this, direction, m_MinFirstDimension, m_MinSecondDimension, m_Orientation);
            else
                m_Resizer = new SquareResizer(this, direction, m_MinFirstDimension, m_MinSecondDimension, m_Orientation);
        ...
        class SquareResizer : MouseManipulator
        {
            ...
            public SquareResizer(TwoPaneSplitView splitView, int dir, float minFirstDimension, float minSecondDimension, Orientation orientation)
            {
                m_Orientation = orientation;
                m_MinFirstDimension = minFirstDimension;
                m_MinSecondDimension = minSecondDimension;
            ...
            {
                float oldDimension = m_Orientation == Orientation.Horizontal ? m_Pane.resolvedStyle.width : m_Pane.resolvedStyle.height;
                ...
                float maxLength = m_Orientation == Orientation.Horizontal ? m_SplitView.resolvedStyle.width - m_MinSecondDimension
                    : m_SplitView.resolvedStyle.height - m_MinSecondDimension;
